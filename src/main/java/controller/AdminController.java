...
public class AdminController extends HttpServlet {
    ...
    private void listAchatsUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("WEB-INF/userAchat.jsp").forward(request, response);
    }
    ...
    private void listAchats(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("productsList", productsList);
        request.getRequestDispatcher("WEB-INF/achatList.jsp").forward(request, response);
    ...
    private void insertUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String email = request.getParameter("email");
        user user = new user(login, BCrypt.hashpw(pasword,BCrypt.gensalt()), email, nom);
    ...
    private void showNewForm(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("WEB-INF/productForm.jsp").forward(request, response);
