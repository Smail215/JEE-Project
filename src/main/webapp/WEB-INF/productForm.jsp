        ...
        <div class="header-wrapper row m-0">
            ...
            <div class="header-logo-wrapper col-auto p-0">
                <div class="logo-wrapper"><a href="adminIndex.jsp"><img class="img-fluid"
                                                                        src="assets22/images/logo/logo.png" alt=""></a>
                </div>
                ...
                <ul class="nav-menus">
                    ...
                    <li class="profile-nav onhover-dropdown p-0 me-0">
                        <div class="media profile-media"><img class="b-r-10"
                                                              src="assets22/images/dashboard/profile.jpg" alt="">
        ...
        <div class="sidebar-wrapper">
            <div>
                <div class="logo-wrapper"><a href="adminIndex.jsp"><img class="img-fluid for-light"
                                                                        src="assets22/images/logo/logo.png" alt=""><img
                        class="img-fluid for-dark"
                        src="assets22/images/logo/logo_dark.png" alt=""></a>
                                    ...
                                    <form action="AdminController" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <select class="form-control" name="categorie">
                                                            ...
                                                            <option value="accessoire ordinateur">accessoire ordinateur
                                                            </option>
                                                            <option value="stockage"> stockage</option>
                                                            <option value="composant pc">composant pc</option>
                                                            <option value="tablette et telephone">tablette & telephone
                                                            </option>
                                            ...
                                            <div class="card-footer text-end">
                                                ...
                                                <input name="action" type="hidden" value="listProducts">
